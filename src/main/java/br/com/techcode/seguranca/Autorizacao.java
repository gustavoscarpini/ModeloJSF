...
import br.com.techcode.service.GrupoRecursoService;
import br.com.techcode.service.GrupoUsuarioService;
...
//        }
        ...
        for (GruposUsuario gu : gruposUsuario) {
            if (grupoRecursoService.listaGrupoRecursosUsuario(gu, recursoSistema)) {
                return true;
            }
        }
