package br.com.bycodesign.seguranca;

import br.com.bycodesign.entidades.Usuario;
import br.com.bycodesign.enums.TipoUsuario;
import br.com.bycodesign.negocios.UsuarioFacade;
import br.com.bycodesign.util.Seguranca;
...
public class UsuarioSistemaAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        if (authentication instanceof UsernamePasswordAuthenticationToken) {
            if("admin".equals(authentication.getPrincipal().toString()) && "codesign".equals(authentication.getCredentials().toString())){
